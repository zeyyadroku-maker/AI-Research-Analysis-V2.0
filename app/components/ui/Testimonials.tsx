    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card p-8 rounded-2xl relative hover:-translate-y-1 transition-transform duration-300">
                <div className="absolute -top-4 left-8 w-8 h-8 bg-primary-500 rounded-full flex items-center justify-center text-white text-xl font-serif">
                    &quot;
                </div>
                ...
                <div>
                    ...
                    <div className="text-sm text-primary-600 dark:text-primary-400 font-mono">Neuroscience</div>
                </div>
            </div>

            <div className="glass-card p-8 rounded-2xl relative hover:-translate-y-1 transition-transform duration-300">
                <div className="absolute -top-4 left-8 w-8 h-8 bg-accent-purple rounded-full flex items-center justify-center text-white text-xl font-serif">
                    &quot;
                </div>
                <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed italic">
                ...
                <div>
                    ...
                    <div className="text-sm text-accent-purple font-mono">Anthropology</div>
                </div>
            </div>

            <div className="glass-card p-8 rounded-2xl relative hover:-translate-y-1 transition-transform duration-300">
                <div className="absolute -top-4 left-8 w-8 h-8 bg-accent-teal rounded-full flex items-center justify-center text-white text-xl font-serif">
                    &quot;
                </div>
                <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed italic">
                ...
                <div>
                    ...
                    <div className="text-sm text-accent-teal font-mono">Environmental Science</div>
                </div>
            </div>
        </div>
    )
