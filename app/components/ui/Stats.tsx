    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="glass-card p-8 rounded-2xl text-center group hover:-translate-y-1 transition-transform duration-300">
                <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-primary-500 to-primary-700 bg-clip-text text-transparent mb-2">
            ...
            <div className="glass-card p-8 rounded-2xl text-center group hover:-translate-y-1 transition-transform duration-300">
                <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-accent-teal to-primary-500 bg-clip-text text-transparent mb-2">
            ...
            <div className="glass-card p-8 rounded-2xl text-center group hover:-translate-y-1 transition-transform duration-300">
                <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-accent-orange to-red-500 bg-clip-text text-transparent mb-2">
