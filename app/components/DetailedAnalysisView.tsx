      ...
      <div className="relative w-full max-w-7xl max-h-[90vh] bg-white dark:bg-dark-900 rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200 dark:border-dark-700">
        ...
        <div className="flex-shrink-0 px-6 py-4 border-b border-gray-100 dark:border-dark-800 flex justify-between items-center bg-white dark:bg-dark-900 z-20">
          <div className="flex-1 min-w-0 mr-4">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mt-1">
              ...
              <span>•</span>
              <span className={`px-2 py-0.5 rounded-full text-xs font-bold ${analysis.analysisDepth === 'Full Text'
                ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300'
                : 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300'
                }`}>
                {analysis.analysisDepth || 'Abstract Only'}
              </span>
            </div>
          </div>
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8 bg-white dark:bg-dark-900 scroll-smooth">
            ...
            {analysis.credibility.rating === 'Invalid' ? (
              // Analyzing State - Minimal & Professional
              <div className="w-full h-full min-h-[500px] flex flex-col items-center justify-center bg-white dark:bg-dark-900 rounded-3xl border border-gray-100 dark:border-dark-700">
                <div className="font-heading text-5xl md:text-6xl font-semibold tracking-tight px-8 flex items-center gap-2" style={{ lineHeight: '1.5', paddingTop: '3rem', paddingBottom: '3rem' }}>
                  <span
                  ...
                  <span className="inline-flex gap-1" style={{ lineHeight: '1.5' }}>
                    <span
                      className="bg-gradient-to-r from-blue-500 via-teal-400 to-green-500 bg-clip-text text-transparent"
                      style={{
                        backgroundSize: '200% 200%',
                        animation: 'gradient-shift 8s ease infinite, dotSequence 2.5s ease-in-out 0s infinite',
                        display: 'inline-block'
                      }}
                    >.</span>
                    <span
                      ...
                      style={{
                        backgroundSize: '200% 200%',
                        animation: 'gradient-shift 8s ease infinite, dotSequence 2.5s ease-in-out 0.6s infinite',
                        display: 'inline-block'
                      }}
                    >.</span>
                    <span
                      ...
                      style={{
                        backgroundSize: '200% 200%',
                        animation: 'gradient-shift 8s ease infinite, dotSequence 2.5s ease-in-out 1.2s infinite',
                        display: 'inline-block'
                      }}
                    >.</span>
                  </span>
